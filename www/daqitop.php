...
<?php //rolling 24hr pm2.5
 ...
 if ($aqiweather["pm25"]>70){echo "<topdaqi10>",$aqiweather["pm25"]."<smallwindunit>".$aqiweather["pm_units"] ; $aqiweather["band"]="Very Hi 10";}
  ...
  ?>
  <a alt="Air Quality Chart" title="Air Quality Chart" href="<?php echo $chartsource;?>/<?php echo $theme1;?>-charts.html?chart='airqualityplot'&span='weekly'&temp='<?php echo $weather['temp_units'];?>'&pressure='<?php echo $weather['barometer_units'];?>'&wind='<?php echo $weather['wind_units'];?>'&rain='<?php echo $weather['rain_units']?>" data-lity >
...
<?php //rolling 24hr PM10
 ...
 else if ($aqiweather["pm10"]>1058){echo "<topdaqi8>",$aqiweather["pm10"]."<smallwindunit>".$aqiweather["pm_units"] ; $aqiweather["band"]="High 8";}
